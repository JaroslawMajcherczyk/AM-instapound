...
const PostListItem = ({post, userId, triggerRefresh}) => {
    ...
    return (
        <View style={{marginBottom: 15}}>
            ...
            <PostHeader uploadedBy={uploaded_by} userIsOwner={userId === uploaded_by.id} postId={id} triggerRefresh={triggerRefresh}/>
